 ...
 * specific command needs (a branch name, a DDL statement, ...), then run via {@link #execute()}. {@code
 * DbGitService} owns turning a raw command line into the right concrete {@link Command}; each command owns only
 * its own behavior.
 */
